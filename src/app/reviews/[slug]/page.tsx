...
export default async function ReviewPage({ params }: Props) {
  ...
  // Inline i18n map for Server Component (page-specific text)
  const ui = {
    ...
    updated: { en: "Updated May 2026", zh: "更新于 2026年5月", ru: "Обновлено: май 2026", ja: "2026年5月更新", fr: "Mis à jour mai 2026", de: "Aktualisiert Mai 2026" },
  ...
  // Helper: get locale from cookie or default to "en"
  // In SSG we default to "en" — client-side language switching handles the rest
  const locale = "en";
      ...
      <section className="review-hero">
        <div className="container">
          <Breadcrumb customItems={[
            ...
            { label: `${browser.name} ${i(ui.review)}`, href: `/reviews/${browser.slug}` },
          ]} />
