...
const staticPages: SearchResult[] = [
  ...
  { type: "page", title: "Contact AntiBrowserHub", description: "Editorial, privacy, partnership, and general contact details", href: "/contact", icon: "✉️" },
  ...
  { type: "page", title: "Affiliate Disclosure", description: "How affiliate links are disclosed and separated from ratings", href: "/affiliate-disclosure", icon: "🤝" },
