...
const ui = {
  ...
  sections: [
    ...
    {
      title: { en: "Advertising Partners", zh: "广告合作伙伴", ru: "Рекламные партнёры", ja: "広告パートナー", fr: "Partenaires publicitaires", de: "Werbepartner" },
      content: { en: "We may display ads from third-party advertising partners, including Google AdSense if our site is approved. These partners may use cookies or similar technologies to serve and measure ads. You can control personalized advertising through your Google ad settings and your browser privacy controls.", zh: "如果网站获得批准，我们可能展示来自第三方广告合作伙伴的广告，包括 Google AdSense。这些合作伙伴可能使用 Cookie 或类似技术来投放和衡量广告。您可以通过 Google 广告设置和浏览器隐私设置控制个性化广告。", ru: "Мы можем показывать рекламу сторонних рекламных партнёров, включая Google AdSense, если сайт будет одобрен. Эти партнёры могут использовать cookies или похожие технологии для показа и измерения рекламы. Вы можете управлять персонализированной рекламой в настройках рекламы Google и настройках конфиденциальности браузера.", ja: "サイトが承認された場合、Google AdSense を含む第三者広告パートナーの広告を表示することがあります。これらのパートナーは、広告の配信や測定のために Cookie などの技術を使用する場合があります。Google の広告設定やブラウザのプライバシー設定でパーソナライズ広告を管理できます。", fr: "Nous pouvons afficher des annonces de partenaires publicitaires tiers, y compris Google AdSense si le site est approuvé. Ces partenaires peuvent utiliser des cookies ou technologies similaires pour diffuser et mesurer les annonces. Vous pouvez gérer la publicité personnalisée via les paramètres publicitaires Google et les contrôles de confidentialité de votre navigateur.", de: "Wir können Anzeigen von Drittanbietern anzeigen, einschließlich Google AdSense, falls unsere Website genehmigt wird. Diese Partner können Cookies oder ähnliche Technologien verwenden, um Anzeigen auszuliefern und zu messen. Sie können personalisierte Werbung über Ihre Google-Anzeigeneinstellungen und die Datenschutzfunktionen Ihres Browsers steuern." },
    },
    {
